...
sophia_state_gas(_Cfg) ->
    ...
    %% Test that one more key in map does not mean more gas - maps are represented as an
    %% identifier, so all maps have the same constant size.
